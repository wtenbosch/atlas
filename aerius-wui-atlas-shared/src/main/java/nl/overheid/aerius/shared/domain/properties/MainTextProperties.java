...
public class MainTextProperties extends MainProperties {
  private static final String TEXT = "text";
  private static final String REFERENCE_NAME = "reference_name";

  public MainTextProperties() {
    this(new HashMap<>());
  }

  public MainTextProperties(final Map<String, Object> map) {
    super(map);
  }
  ...
  public void setReferenceName(final String referenceName) {
    put(REFERENCE_NAME, referenceName);
  }
}
