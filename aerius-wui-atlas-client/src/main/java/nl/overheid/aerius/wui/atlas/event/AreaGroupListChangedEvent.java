...
public class AreaGroupListChangedEvent extends SimpleGenericEvent<Map<AreaGroupType, List<NatureArea>>> {
  public AreaGroupListChangedEvent(final Map<AreaGroupType, List<NatureArea>> value) {
    super(value);
  }
}
