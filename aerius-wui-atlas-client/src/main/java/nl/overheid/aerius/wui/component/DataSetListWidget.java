...
public class DataSetListWidget extends VerticalMenuItemListWidget<DatasetConfiguration> {
  private final DataSetListWidgetEventBinder EVENT_BINDER = GWT.create(DataSetListWidgetEventBinder.class);

  interface DataSetListWidgetEventBinder extends EventBinder<DataSetListWidget> {}
  ...
  @Override
  protected final VerticalMenuItemPopup<DatasetConfiguration> createMenuPopup() {
    return new VerticalMenuItemPopup<>(v -> getName(v));
  }
