...
public class AtlasActivityMapper<F extends AtlasActivityFactory> implements ActivityMapper {
  ...
  protected Activity<?> tryGetActivity(final Place place) {
  ...
  protected Activity<?> getStoryActivity(final Place place) {
