...
public class StoryPlace extends ApplicationPlace {
  ...
  public static class Tokenizer implements PlaceTokenizer<StoryPlace> {
    ...
    public StoryPlace getPlace(final String token) {
      ...
      final StoryPlace place = new StoryPlace();
  ...
  public StoryPlace copy() {
    return copyTo(new StoryPlace());
  }

  public <E extends StoryPlace> E copyTo(final E copy) {
    copy.setPanel(panel);
    copy.setStory(story);
