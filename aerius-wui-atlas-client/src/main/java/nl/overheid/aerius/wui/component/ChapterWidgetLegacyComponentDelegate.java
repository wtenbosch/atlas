...
public class ChapterWidgetLegacyComponentDelegate extends BasicEventComponent implements PanelWidgetDelegate, HasEventBus {
  interface ChapterWidgetComponentDelegateEventBinder extends EventBinder<ChapterWidgetLegacyComponentDelegate> {}
  ...
  @Inject
  public ChapterWidgetLegacyComponentDelegate(@Assisted final PanelContent conf, final @Assisted AcceptsOneWidget target,
  ...
  @Override
  public void show() {
    if (component != null && component.getParentElement() != null) {
    ...
    LegacyWebComponentUtil.inject(properties, target, eventBus, c -> initComponentParameters(c));
  }
