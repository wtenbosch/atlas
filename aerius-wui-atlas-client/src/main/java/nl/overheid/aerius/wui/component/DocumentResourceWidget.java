...
public class DocumentResourceWidget extends Composite {
  private static final DocumentResourceWidgetUiBinder UI_BINDER = GWT.create(DocumentResourceWidgetUiBinder.class);

  interface DocumentResourceWidgetUiBinder extends UiBinder<Widget, DocumentResourceWidget> {}
  ...
  public DocumentResourceWidget(final DocumentResource resource) {
