...
public abstract class HorizontalImageMenuItemListWidget<P extends AbstractMenuItemPopup<T>, T> extends MenuItemListWidget<P, T> {
  ...
  interface ImageMenuItemListWidgetUiBinder extends UiBinder<Widget, HorizontalImageMenuItemListWidget<?, ?>> {}

  public @UiField SimplePanel imagePanel;

  public HorizontalImageMenuItemListWidget(final P popup) {
    super(popup);
  }
