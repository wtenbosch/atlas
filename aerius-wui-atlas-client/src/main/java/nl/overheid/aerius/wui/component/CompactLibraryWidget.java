...
import nl.overheid.aerius.wui.widget.ImageMenuItemListWidget;

public class CompactLibraryWidget extends ImageMenuItemListWidget<LibraryMenuItemPopup, StoryInformation> {
  private static final CompactLibraryWidgetEventBinder EVENT_BINDER = GWT.create(CompactLibraryWidgetEventBinder.class);

  interface CompactLibraryWidgetEventBinder extends EventBinder<CompactLibraryWidget> {}

  private Story lastKnownStory;

  public CompactLibraryWidget() {
    super(new LibraryMenuItemPopup());

    initWidget();
    ensureDebugId(AtlasTestIDs.BUTTON_LIBRARY);
  }
