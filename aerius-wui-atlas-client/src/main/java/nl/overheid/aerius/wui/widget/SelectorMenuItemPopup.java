...
public class SelectorMenuItemPopup<T extends Selector> extends VerticalMenuItemPopup<T> {
  public SelectorMenuItemPopup() {}

  public SelectorMenuItemPopup(final String titleTxt, final String descriptionTxt) {
