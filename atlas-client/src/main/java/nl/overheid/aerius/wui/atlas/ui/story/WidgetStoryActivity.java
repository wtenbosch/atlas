...
public class WidgetStoryActivity extends EventActivity<StoryPresenter, StoryView> implements StoryPresenter {
  private final StoryCommandRouter commandRouter;

  @Inject
  public WidgetStoryActivity(final StoryView view, final StoryCommandRouter commandRouter, final StoryPlaceTracker placeTracker) {
