...
@Singleton
public class EmissieRegistratieActivatorAssistant extends BasicEventComponent implements ActivatorAssistant {
  interface MonitorUpActivatorAssistantEventBinder extends EventBinder<EmissieRegistratieActivatorAssistant> {}
