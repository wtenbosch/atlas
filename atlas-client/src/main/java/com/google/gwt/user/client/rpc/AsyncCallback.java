 ...
 *
 * <p>
 * A call with a typical use of <code>AsyncCallback</code> might look like this:
 *
 * <pre class="code">
...
public interface AsyncCallback<T> {
   ...
   * {@link IncompatibleRemoteServiceException}s, {@link InvocationException}s, or
   * checked exceptions thrown by the service method are examples of the type of
   * failures that can be passed to this method.
   *
   * <p>
   * If <code>caught</code> is an instance of an
   * {@link IncompatibleRemoteServiceException} the application should try to get
   * into a state where a browser refresh can be safely done.
   * </p>
   *
