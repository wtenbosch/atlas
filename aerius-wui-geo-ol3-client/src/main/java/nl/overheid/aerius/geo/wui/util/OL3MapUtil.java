...
public final class OL3MapUtil {
  ...
  public static IsLayer<Layer> prepareInformationLayer(final Map map, final Projection projection, final EventBus eventBus,
    ...
    return new InformationLayer(projection, eventBus);
  }
